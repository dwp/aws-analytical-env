...
module "emr" {
  ...
  security_configuration_groups = {
    UC_DataScience_PII     = ["HiveDataPII", "AnalyticalDatasetCrownReadOnly", "ReadPDMPiiAndNonPii"],
    UC_DataScience_Non_PII = ["HiveDataNonPII", "AnalyticalDatasetCrownReadOnlyNonPii", "ReadPDMNonPiiOnly"]
  }
