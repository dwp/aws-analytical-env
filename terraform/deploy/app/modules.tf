...
module "emr" {
  ...
  security_configuration_groups = {
    UC_DataScience_PII     = ["AnalyticalDatasetCrownReadOnly", "ReadPDMPiiAndNonPii", "HiveDataAccessUC_DataScience_PII"],
    UC_DataScience_Non_PII = ["AnalyticalDatasetCrownReadOnlyNonPii", "ReadPDMNonPiiOnly", "HiveDataAccessUC_DataScience_Non_PII"]
  }
