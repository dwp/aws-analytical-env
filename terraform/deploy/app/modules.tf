...
module "emr" {
  ...
  security_configuration_groups = {
    UC_DataScience_PII     = ["AnalyticalDatasetCrownReadOnly", "ReadPDMPiiAndNonPii", "HiveDataPII"],
    UC_DataScience_Non_PII = ["AnalyticalDatasetCrownReadOnlyNonPii", "ReadPDMNonPiiOnly", "HiveDataNonPII"]
  }
