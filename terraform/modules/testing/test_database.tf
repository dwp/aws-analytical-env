...
data "template_file" "create_metrics_data_template" {
  template = file("${path.module}/${var.create_metrics_data_lambda_file_path}_templates/create_metrics_data_lambda.py")
  vars = {
